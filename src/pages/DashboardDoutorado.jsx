  ...
  const charts = (
    <>
      <ChartCard
        ...
        chartProps={{
          csvFileName: "doutorado/doutorado_tipo_matricula.csv",
          xColumn: "Tipo",
      ...
      <ChartCard
        ...
        ChartComponent={BarChart}
        chartProps={{
          csvFileName: "doutorado/doutorado_prorrogacao.csv",
          xColumn: "Razão",
          valueColumns: ["Feminino", "Masculino"],
          groupMode: "grouped",
          legendOffsetBt: 35,
      ...
      <ChartCard
        ...
        ChartComponent={BarChart}
        chartProps={{
          csvFileName: "doutorado/doutorado_desligados.csv",
          xColumn: "Razão",
          valueColumns: ["Feminino", "Masculino"],
          groupMode: "grouped",
          legendOffsetBt: 35,
      ...
      <ChartCard
        ...
        ChartComponent={BarChart}
        chartProps={{
          csvFileName: "doutorado/doutorado_inscritos_ano.csv",
          xColumn: "Ano",
          valueColumns: ["Feminino", "Masculino"],
          tickRotation: -90,
          legendOffset: 50,
      ...
      <ChartCard
        ...
        ChartComponent={BarChart}
        chartProps={{
          csvFileName: "doutorado/doutorado_formados_ano.csv",
          xColumn: "Ano",
          valueColumns: ["Feminino", "Masculino"],
          tickRotation: -90,
          legendOffset: 50,
      ...
      <ChartCard
        ...
        ChartComponent={BarChart}
        chartProps={{
          csvFileName: "doutorado/doutorado_rendimento_ano.csv",
          xColumn: "Ano",
          valueColumns: ["Feminino", "Masculino"],
          tickRotation: -90,
          ariaLabel:
      ...
      <ChartCard
        ...
        ChartComponent={BarChart}
        chartProps={{
          csvFileName: "doutorado/doutorado_desistentes_ano.csv",
          xColumn: "Ano",
          valueColumns: ["Feminino", "Masculino"],
          tickRotation: -90,
          ariaLabel:
      ...
      <ChartCard
        ...
        ChartComponent={BarChart}
        chartProps={{
          csvFileName: "doutorado/doutorado_trancados_ano.csv",
          xColumn: "Ano",
          valueColumns: ["Feminino", "Masculino"],
          tickRotation: -90,
          ariaLabel:
